...
try
{
  ...
  $sfAssetFolder = sfAssetFolderPeer::retrieveByPath(sfConfig::get('app_sfDoctrineAssetsLibrary_upload_dir', 'media'));
  $t->ok($sfAssetFolder->isRoot(), 'retrieveByPath() retrieves root from app_sfDoctrineAssetsLibrary_upload_dir string');

  $sfAssetFolder = sfAssetFolderPeer::retrieveByPath();
  $t->ok($sfAssetFolder->isRoot(), 'retrieveByPath() retrieves root from empty string');
  
  $sfAssetFolder = sfAssetFolderPeer::createFromPath(sfConfig::get('app_sfDoctrineAssetsLibrary_upload_dir', 'media').'/simple');
  ...
  $sfAssetFolder2 = sfAssetFolderPeer::createFromPath(sfConfig::get('app_sfDoctrineAssetsLibrary_upload_dir', 'media').'/simple/subfolder');
  ...
  $sfAssetFolder = sfAssetFolderPeer::createFromPath(sfConfig::get('app_sfDoctrineAssetsLibrary_upload_dir', 'media').'/second/subfolder');
